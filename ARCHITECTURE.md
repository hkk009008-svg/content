...
non-empty, `_fal_flux_fallback` ([phase_c_assembly.py:617](phase_c_assembly.py:617)) takes the multi-char
branch: `_allocate_ref_slots` ([phase_c_assembly.py:552](phase_c_assembly.py:552)) partitions the Kontext
