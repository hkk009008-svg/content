...
- `build_remediation_advisory` (new, `llm/negative_prompts.py:52`) — called from
  `generate_keyframe_take` (`cinema/shots/controller.py:478`) and `diagnose_clip`
...
> Test suite state (verified 2026-06-10, Session-1 P0 + review follow-ups applied):
> **1982 pass / 0 skip / 0 fail** in `tests/unit/`. Run
