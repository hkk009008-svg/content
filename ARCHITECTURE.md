...
| Shot work | [cinema/shots/controller.py](cinema/shots/controller.py) (2580 LOC) | `generate_keyframe_take`, `generate_performance_take`, `generate_motion_take`, `regenerate_shot`, `restart_shot`, `diagnose_clip`, `apply_correction`, `generate_scene_preview`. |
...
- `build_remediation_advisory` (new, `llm/negative_prompts.py:55`) — called from
  `generate_keyframe_take` (defined at `cinema/shots/controller.py:614`; call at :846) and `diagnose_clip`
