...
| Shot work | [cinema/shots/controller.py](cinema/shots/controller.py) (2590 LOC) | `generate_keyframe_take`, `generate_performance_take`, `generate_motion_take`, `regenerate_shot`, `restart_shot`, `diagnose_clip`, `apply_correction`, `generate_scene_preview`. |
