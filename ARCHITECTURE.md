...
| Shot work | [cinema/shots/controller.py](cinema/shots/controller.py) (2552 LOC) | `generate_keyframe_take`, `generate_performance_take`, `generate_motion_take`, `regenerate_shot`, `restart_shot`, `diagnose_clip`, `apply_correction`, `generate_scene_preview`. |
...
**2712 LOC, 66 `@app.route` decorators, 65 view functions** (one handler binds
two URLs — `/assemble` + `/proceed-assembly`, [web_server.py:2220-2221](web_server.py:2220)).
...
Helper at [cinema/auto_approve.py:611](cinema/auto_approve.py:611); conditional
at [cinema/review/controller.py:280-281](cinema/review/controller.py:280).
Parser at [cinema/auto_approve.py:620](cinema/auto_approve.py:620):
