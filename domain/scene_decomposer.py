...
API_REGISTRY = {
    ...
    "OMNIHUMAN_V1_5":{"label": "Omnihuman v1.5",       "category": "lipsync",   "description": "ByteDance — full talking head from a still image + audio (60s max); still the latest OmniHuman as of 2026-07", "modality": "lipsync", "best_for": ["talking_head_full"], "per_shot_cost": 0.80, "quality_score": 0.88, "latency_s": 120, "status": "live"},
