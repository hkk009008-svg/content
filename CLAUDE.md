...
ahead of activation. **Activation + dogfood (2026-06-09, this commit):**
the runtime is now **2.1.169** (≥ 2.1.154 → hard-gate SATISFIED) and the
feature has been used **~18× across this arc** by both seats — the C4
dogfood retro is DISCHARGED above (verdict: net-positive, retained as-is).
