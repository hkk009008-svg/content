...
export default function AssemblyGate({ project }: Props) {
  return (
    <div className="mt-6 p-6 bg-ok/5 border border-ok/20 rounded-xl text-center">
      <div className="text-3xl mb-3">🎬</div>
      <h2 className="text-xl font-bold text-tx mb-2">Generation Complete</h2>
      ...
      <div className="flex justify-center gap-4">
        <a
          ...
          className="inline-flex items-center gap-2 bg-ok hover:bg-green-600 text-white
      ...
      <div className="mt-6 text-eyebrow-lg text-mut">
