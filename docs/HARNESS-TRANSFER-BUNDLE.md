...
| `~/.claude/skills/` (global) | `probe-a-claim`, `prove-a-control`, `check-artifact-that-runs`, `falsify-first-debugging`, `audit-a-contract-seam` — the portable verification core. | Session-proven 2026-08-07; seam audit added 2026-08-08 | — |
