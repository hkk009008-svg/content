...
- **DRAFT v0.9.1** — folds joint v0.9 mid-prep review findings from both seats per operator REPLY §2 hybrid protocol. Director side (T10:46:03Z verification-report `fe26804`): 7 findings on 7 operator-authored PA-* cells. Operator side (T10:45:00Z verification-report `49c8af3`): 22 net findings on 23 director-authored P + G + PR cells. **v0.9.1 closes 5 IMPORTANT + 5 high-value MINOR + 2 INFORMATIONAL markers** per user-selected Option A (focused fold; load-bearing tightening) — defers ADR-013-basis additions to all P-* cells (F-13, F-22) + cross-phase missing-mode predictions (F-14, F-17, F-21) to v0.9.2 or advisory. Substantive state: **ALL 30 test cell PREDICTIONs filled** (9 P + 6 G + 8 PR + 7 PA); **ALL 9 user §9 questions ANSWERED**; impl-mismatch line refs corrected to HEAD (F-1 G-PERF `cinema_pipeline.py:944-961`; F-20 §6 matrix iterate path); unfalsifiable phrasing tightened where flagged (F-11 P-DECOMPOSE/P-CHIEFDIR/PR-MOTION/PR-CONTINUITY); cross-cell contradictions closed (F-4 PR-STORY field; F-9 PR-CONTINUITY return shape; F-16 G-SCREEN failure-mode #2; my F1 PA-IMAGE↔P-KEYFRAME cost range; F-2 §5.5 G-PLAN field). Operator REPLY folded at `a9b1c32` preserved; Candidate #8 filed at `1af3528` preserved.
