"""VENDORED — AdaFace IR/IR-SE backbone definition (verbatim).

Source:  https://github.com/mk-minchul/AdaFace  (net.py, master, fetched 2026-07-11)
License: MIT — Copyright (c) 2022 Minchul Kim (see repo LICENSE)
Why vendored: AdaFace is not a DeepFace built-in; the released .ckpt state
dicts key against exactly this module structure (Lightning 'state_dict' with
'model.' prefix — see identity/adaface.py). Do NOT reformat or rename
layers: any structural edit breaks checkpoint loading.
