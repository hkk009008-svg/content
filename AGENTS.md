...
This project is indexed by GitNexus as **Content** (3299 symbols, 21149 relationships, 280 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
