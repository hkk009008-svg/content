...
This project is indexed by GitNexus as **Content** (3173 symbols, 20280 relationships, 269 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
