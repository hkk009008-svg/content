...
This project is indexed by GitNexus as **Content** (3199 symbols, 20432 relationships, 271 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
