...
This project is indexed by GitNexus as **Content** (3117 symbols, 19825 relationships, 264 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
