...
This project is indexed by GitNexus as **Content** (2875 symbols, 18296 relationships, 242 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
