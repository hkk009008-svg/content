...
This project is indexed by GitNexus as **Content** (3147 symbols, 20089 relationships, 267 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
