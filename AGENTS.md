...
This project is indexed by GitNexus as **Content** (4281 symbols, 23501 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
