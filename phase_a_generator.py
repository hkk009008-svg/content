    ...
    tool_schema = {
        ...
        "input_schema": {
            ...
            "properties": {
                ...
                "character_id": {
                    "type": "string",
                    "enum": ["the_strategist", "the_cyber_architect", "the_machiavellian"],
                    "description": "Select the master Character ID. This locks their precise facial structure, voice, and aesthetic across the entire film via backend IP-Adapters."
                },
            ...
            "required": ["ab_test_titles", "hook", "body_paragraphs", "character_id", "infinite_loop_bridge", "ai_image_prompts", "youtube_description", "youtube_tags", "music_vibe", "video_pacing", "playlist_category"]
        }
    }
